...
# test1 = "ikhsan kamu tidak boleh seperti itu, dengar tu"
test2 = "bagaimana gurbernur melakukan kekerasan perempuan? Buktinya banyak ibu2 mau foto bareng"

# print(sentiment(test1))
print(sentiment(test2))